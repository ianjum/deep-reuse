...
# Modified by Lin Ning since March 1, 2018
# ==============================================================================
...
def cifarnet(images, num_classes=10,
             quant_params=[], is_training=False,
...
#       net = ulayer.conv2d(net, 64, [5, 5], scope='conv2', quantized=True, quantization_params=quant_params[1])
